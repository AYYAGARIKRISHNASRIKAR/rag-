...
def show_login_page(mongo_db):
    ...
    st.markdown(
        """<h2 style="color: #e0b4de; font-family: 'Caveat', cursive;">
            🔐 Login
        </h2>""",
    ...
    with col1:
        with st.container(border=True):
            st.markdown(
                """<h3 style="color: #c9e88b; font-family: 'Caveat', cursive;">
                     Welcome Back !
                </h3>""",
                unsafe_allow_html=True
            )
    ...
    with col2:
        with st.container(border=True):
            ...
            st.markdown(
                """<p style="color: #abebbc; font-family: 'Caveat', cursive;">
                     Create an account to start using our GPU-Accelerated RAG system
                </p>""",
                unsafe_allow_html=True
            )
